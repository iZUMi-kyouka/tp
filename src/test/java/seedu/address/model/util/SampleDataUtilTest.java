...
public class SampleDataUtilTest {
    ...
    public void getSampleRecruits_returnsCorrectRecruits() {
        ...
        assertEquals("Blk 30 Geylang Street 29, #06-40", alex.getAddress().toString());
        ...
        assertEquals("Blk 30 Lorong 3 Serangoon Gardens, #07-18", bernice.getAddress().toString());
        ...
        assertEquals("93210283", charlotte.getPhone().toString());
        assertEquals("charlotte@example.com", charlotte.getEmail().toString());
        ...
        assertEquals("91031282", david.getPhone().toString());
        assertEquals("lidavid@example.com", david.getEmail().toString());
        assertEquals("Blk 436 Serangoon Gardens Street 26, #16-43", david.getAddress().toString());
        ...
        assertEquals("92492021", irfan.getPhone().toString());
        assertEquals("irfan@example.com", irfan.getEmail().toString());
        assertEquals("Blk 47 Tampines Street 20, #17-35", irfan.getAddress().toString());
        ...
        assertEquals("92624417", roy.getPhone().toString());
        assertEquals("royb@example.com", roy.getEmail().toString());
        assertEquals("Blk 45 Aljunied Street 85, #11-31", roy.getAddress().toString());
