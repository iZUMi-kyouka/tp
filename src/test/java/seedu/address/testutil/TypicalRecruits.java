...
public class TypicalRecruits {
    ...
    public static final Recruit AMY = new RecruitBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Recruit BOB = new RecruitBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
