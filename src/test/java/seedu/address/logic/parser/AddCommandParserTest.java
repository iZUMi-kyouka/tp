...
public class AddCommandParserTest {
    ...
    public void parse_repeatedValues_success() {
        ...
        // multiple phones
        recruit = new SimpleRecruitBuilder(BOB).withAdditionalPhones(AMY.getPhone().value).build();
        assertParseSuccess(parser, validExpectedRecruitString + PHONE_DESC_AMY, new AddCommand(recruit));

        // multiple emails
        recruit = new SimpleRecruitBuilder(BOB).withAdditionalEmails(AMY.getEmail().value).build();
        assertParseSuccess(parser, validExpectedRecruitString + EMAIL_DESC_AMY, new AddCommand(recruit));

        // multiple addresses
        recruit = new SimpleRecruitBuilder(BOB).withAdditionalAddresses(AMY.getAddress().value).build();
